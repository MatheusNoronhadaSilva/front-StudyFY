    ...
    <Container style={{backgroundColor: 'white', alignItems: 'center', paddingTop: '1vh'}}>
        ...
        <div style={{width: '100%', flexGrow: '1'}}>
           ...
           <div>
            ...
            <textarea placeholder="Titulo" style={{border:'none', width: '400px', height: '100px', display: 'flex', justifyContent:'center', paddingTop: '25%', fontSize: '20px'}}></textarea>


          <div style={{ height: '100px', width: '414px', border: '2px solid #D9D9D9', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
